...
__attribute__((import_name("get_api_version")))
const int get_api_version() {
    return api_version;
}
...
void attach_internal_calls()
{
    ...
    mono_add_internal_call("PixiEditor.Extensions.Sdk.Bridge.Native::get_api_version", get_api_version);
}
...
__attribute((export_name("get_api_version")))
const int get_api_version_export()
{
