...
public record struct PointerInfo
{
    ...
    public PointerInfo(VecD positionOnCanvas, float pressure, float twist, VecD tilt, VecD movementDirection, float velocity, bool isLeftButtonPressed, bool isRightButtonPressed)
    {
