...
[NodeViewModel("VECTOR_MATH_NODE", "NUMBERS", PixiPerfectIcons.PlusMinus)]
internal class VectorMathNodeViewModel : NodeViewModel<VectorMathNode>
{
    ...
    {
        if (Mode.Value is not VectorMathMode mode)
            return;
