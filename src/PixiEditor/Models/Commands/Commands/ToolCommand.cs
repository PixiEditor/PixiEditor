...
{
    internal class ToolCommand(IToolsHandler handler, bool transient) : Command(transient ? handler.SetToolTransient : handler.SetTool, CommandController.Current.CanExecuteEvaluators["PixiEditor.HasDocument"])
    {
